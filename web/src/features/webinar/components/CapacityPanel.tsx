  ...
  return (
    <Card>
      ...
      <div className="flex flex-wrap gap-2">
        <div className="flex items-center gap-2 rounded-md border border-line px-3 py-1.5 text-base text-ink">
      ...
      {pending.length > 0 ? (
        <div className="mt-3 border-t border-line pt-3">
          <h4 className="mb-1.5 text-base font-medium text-muted">{t("cap.pending", { n: pending.length })}</h4>
          <ul className="space-y-1">
            {pending.map((r) => (
              <li key={r.id} className="flex items-center gap-2 rounded-md border border-line px-3 py-1.5 text-base">
