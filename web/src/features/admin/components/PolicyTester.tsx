      ...
      <div className="mt-3 flex flex-wrap items-center gap-2">
        ...
        {LABELS.map((l) => (
          <button
            ...
            onClick={() => setLabel(l)}
            className={clsx(
              "rounded-lg border px-2.5 py-1.5 text-sm transition-[transform,color,background-color,border-color] duration-150 ease-[var(--ease-out)] motion-safe:active:scale-[0.97]",
              label === l
