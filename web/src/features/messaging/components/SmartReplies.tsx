...
export function SmartReplies({ onPick }: { onPick: (text: string) => void }) {
  ...
  return (
    <div className="no-scrollbar flex flex-nowrap items-center gap-2 overflow-x-auto px-1 pb-2 md:flex-wrap">
      <HiOutlineSparkles className="h-3.5 w-3.5 shrink-0 text-brand" aria-hidden />
