          ...
          <div className="flex w-full items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="font-semibold dark:text-white">
                ...
                <div id="mailDetailsDropdown" className="z-50 hidden w-[360px] rounded-sm bg-surface p-4 shadow-sm origin-top-left motion-safe:[animation:tl-pop-in_var(--dur-pop)_var(--ease-out)] dark:bg-gray-700">
